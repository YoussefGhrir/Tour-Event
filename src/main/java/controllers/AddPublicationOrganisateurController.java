...
public class AddPublicationOrganisateurController {
    ...
    public void initialize() {
        ...
        // Ajout du type Événement
        typeComboBox.getItems().setAll(PublicationType.NORMAL, PublicationType.PARKING, PublicationType.EVENEMENT);
    ...
    private void handleAddPublication() {
        ...
        try {
            ...
            } else if (selectedType == PublicationType.PARKING) {
            ...
            } else if (selectedType == PublicationType.EVENEMENT) {
                publication = new Publication(titre, description, imageBytes, userId);
                publication.setType(PublicationType.EVENEMENT);
            } else {
